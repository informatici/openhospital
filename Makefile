...
$(MYSQL_LINUX32):
        wget -q https://downloads.mariadb.com/MariaDB/mariadb-10.2.37/bintar-linux-x86/mariadb-10.2.37-linux-i686.tar.gz -O $(MYSQL_LINUX32)
$(MYSQL_LINUX64):
        wget -q https://downloads.mariadb.com/MariaDB/mariadb-10.2.37/bintar-linux-x86_64/mariadb-10.2.37-linux-x86_64.tar.gz -O $(MYSQL_LINUX64)
$(MYSQL_WIN):
        wget -q https://downloads.mariadb.com/MariaDB/mariadb-10.2.37/winx64-packages/mariadb-10.2.37-winx64.zip -O $(MYSQL_WIN)
