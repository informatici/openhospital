...
$(JRE_LINUX32):
	wget -q -nc https://cdn.azul.com/zulu/bin/zulu11.52.13-ca-jre11.0.13-linux_i686.tar.gz -O $(JRE_LINUX32)
$(JRE_LINUX64):
	# openjdk11
	...
	# jre 11 - zulu
	wget -q -nc https://cdn.azul.com/zulu/bin/zulu11.52.13-ca-jre11.0.13-linux_x64.tar.gz -O $(JRE_LINUX64)
$(JRE_WIN32):
	# openjdk 11
	...
	# jre 11 - zulu
	wget -q -nc https://cdn.azul.com/zulu/bin/zulu11.52.13-ca-fx-jre11.0.13-win_i686.zip -O $(JRE_WIN32)
$(JRE_WIN64):
	# openjdk 11
	...
	# jre 11 - zulu
	wget -q -nc https://cdn.azul.com/zulu/bin/zulu11.52.13-ca-fx-jre11.0.13-win_x64.zip -O $(JRE_WIN64)
$(MYSQL_LINUX32):
