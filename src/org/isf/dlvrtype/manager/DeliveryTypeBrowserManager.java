...
import org.isf.dlvrtype.service.DeliveryTypeIoOperationNew;
...
public class DeliveryTypeBrowserManager {
	...
	private DeliveryTypeIoOperationNew ioOperations = Menu.getApplicationContext().getBean(DeliveryTypeIoOperationNew.class);
