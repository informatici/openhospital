...
public class Tests  
{
	...
	private static TestUserGroup testMedicalType;
	private static TestUserGroupContext testMedicalTypeContext;
    ...
    public static void setUpClass()  
    {
    	...
    	testMedicalType = new TestUserGroup();
    	testMedicalTypeContext = new TestUserGroupContext();
