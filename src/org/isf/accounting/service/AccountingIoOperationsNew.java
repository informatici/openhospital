...
@Component
@Transactional
public class AccountingIoOperationsNew {
	...
	public ArrayList<BillItems> getItems(int billID) throws OHException {
		...
		if (billID != 0)
			return new ArrayList<BillItems>(billItemsRepository.findByBill_idOrderByIdAsc(billID));

		return new ArrayList<BillItems>(billItemsRepository.findAllByOrderByIdAsc());
	}
	 ...
	 */
	public boolean newBillItems(Bill bill, ArrayList<BillItems> billItems) throws OHException {
		boolean result = true;
	...
	private boolean _deleteBillsInsideBillItems(DbJpaUtil jpa, int id) throws OHException {
		ArrayList<Object> params = new ArrayList<Object>();
		boolean result = true;
	...
	private boolean _insertNewBillInsideBillItems(DbJpaUtil jpa, Bill bill, ArrayList<BillItems> billItems)
			throws OHException {
		ArrayList<Object> params = new ArrayList<Object>();
		boolean result = true;
	...
	private ArrayList<Object> _addUpdateBillItemParameters(Bill bill, BillItems item) throws OHException {
		ArrayList<Object> params = new ArrayList<Object>();
	 ...
	 */
	public boolean newBillPayments(Bill bill, ArrayList<BillPayments> payItems) throws OHException {
		boolean result = true;
	...
	private boolean _deleteBillsInsideBillPayments(DbJpaUtil jpa, int id) throws OHException {
		ArrayList<Object> params = new ArrayList<Object>();
		boolean result = true;
	...
	private boolean _insertNewBillInsideBillPayments(DbJpaUtil jpa, Bill bill, ArrayList<BillPayments> billPayments)
			throws OHException {
		ArrayList<Object> params = new ArrayList<Object>();
		boolean result = true;
	...
	private ArrayList<Object> _addUpdateBillPaymentParameters(Bill bill, BillPayments payment) throws OHException {
		ArrayList<Object> params = new ArrayList<Object>();
	...
	private ArrayList<Object> _addUpdateBillParameters(Bill bill) throws OHException {
		ArrayList<Object> params = new ArrayList<Object>();
